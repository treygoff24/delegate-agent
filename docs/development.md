...
Droid real runs require non-placeholder model IDs. Cursor, Codex, and Kimi dry-runs do not require child binaries.
...
Required CI does not need real Cursor, Droid, Codex, or Kimi binaries.
