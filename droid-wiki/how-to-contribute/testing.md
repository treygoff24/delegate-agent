...
Run a focused file while iterating, then run `python3 -m pytest -q` before handoff. See [tracked execution](../systems/tracked-execution.md) for the runtime capture model that many tests exercise.
