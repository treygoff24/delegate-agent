...
| `grok` | Grok binary, model, effort, permission mode, and sandbox behavior. |
| `devin` | Devin binary and default model. |
| `opencode` | OpenCode binary, model aliases, variant, and default agent. |
