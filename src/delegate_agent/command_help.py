...
COMMAND_SPECS: dict[str, CommandSpec] = {
    "cursor": CommandSpec(
        ...
        see_also=("codex", "droid", "dry-run", "agent-help"),
    ),
    "codex": CommandSpec(
        name="codex",
    ...
    "snapshot": CommandSpec(
        ...
        options=(
            OptionSpec(
                "--latest",
                "HARNESS",
                "Snapshot the most recent run for HARNESS (cursor, droid, or codex).",
            ),
    ...
    "runs": CommandSpec(
        ...
        options=(
            ...
            OptionSpec(
                "--harness",
                "HARNESS",
                "Filter by harness: cursor, droid, or codex.",
            ),
    ...
    "worktree show": CommandSpec(
        ...
        options=(
            OptionSpec(
                "--latest",
                "HARNESS",
                "Show the most recent worktree for HARNESS (cursor, droid, or codex).",
            ),
        ),
        examples=(
