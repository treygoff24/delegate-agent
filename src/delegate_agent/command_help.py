...
COMMAND_SPECS: dict[str, CommandSpec] = {
    ...
    "opencode": CommandSpec(
        ...
        notes=(
            ...
            "Plain call without --read-only gets no permission lockdown and runs in the real cwd selected for the call.",
    ...
    "dry-run": CommandSpec(
        ...
        usage=(
            ...
            "[--progress] [--forbid-commit] [--include-dirty] [--prompt-file PATH] [prompt...]",
            "delegate [--json] [--isolation auto|none|worktree] "
            "dry-run droid [MODEL_ALIAS] call [--read-only] [--model <alias-or-model>] [--reasoning-effort LEVEL] "
            "[--prompt-file PATH] [prompt...]",
        ),
        arguments=(
            ArgSpec(
...
def render_overview_text() -> str:
    ...
    usage_lines = [
        ...
        f"delegate [--cwd PATH] [--json] {iso} opencode call [--read-only] [--model <alias-or-model>] [--reasoning-effort LEVEL] [--agent NAME] [--prompt-file PATH] [prompt...]",
        ...
        f"delegate [--cwd PATH] [--json] {iso} dry-run opencode call [--read-only] [--model <alias-or-model>] [--reasoning-effort LEVEL] [--agent NAME] [--prompt-file PATH] [prompt...]",
